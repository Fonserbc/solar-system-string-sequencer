...
let colors = colorPalleteOriginal;
...
let mercury = new planet("mercury", 2439.4, colors[planets.length + 1], scene, 2, 176, textureLoader, 'data/planets/mercury.jpg', 'data/planets/mercurynormal.jpg');
...
let venus = new planet("venus", 6051.8, colors[planets.length + 1], scene, 177, 242, textureLoader, 'data/planets/venus.jpg');
...
let terra = new planet("terra", 6371.0084, colors[planets.length + 1], scene, 23.5, 1, textureLoader, 'data/planets/earth.jpg');
...
let mars = new planet("mars", 3389.50, colors[planets.length + 1], scene, 25, 1.027, textureLoader, 'data/planets/mars.jpg');
